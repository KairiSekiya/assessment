...
//function assessmentの説明
//名前の文字列を与えると診断結果を返す関数、
//@param（引数のこと） {string} userName ユーザの名前
//@return （戻り値のこと）{string} 診断結果
//ポイント：名前の全ての文字のコード番号の整数値を足す、
//足した結果を診断結果のパターン数で割ったあまりを取得する
//あまりを診断結果の配列の添え字として、診断結果の文字列を取得する
...
function test() {
  ...
  console.assert(assessment('太郎') ===assessment('太郎'),
    '入力が同じなら同じ診断結果が出力される処理が正しくありません'
  );
  //次郎
  console.log('次郎');
